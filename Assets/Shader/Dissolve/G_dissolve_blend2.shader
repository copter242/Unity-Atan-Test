...
////// Emissive:
                ...
                return fixed4(finalColor,saturate(((_MainTex_var.a*_alpha)*(1.0 - step((dot(_Dissolve_Tex_var.rgb,float3(0.3,0.59,0.11))*_Dissolve_Tex_var.a),lerp( _diss_amount, ((1.0 - i.vertexColor.a)*1.01+-0.01), _particle_controlA ))))));
            }
            ENDCG
        }
        Pass {
